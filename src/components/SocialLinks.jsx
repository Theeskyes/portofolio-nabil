...
const socialLinks = [
  {
    ...
    subText: "@naabill11",
    icon: Instagram,
    url: "https://www.instagram.com/naabill11",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@nabilakhram1730",
    icon: Youtube,
    url: "https://youtube.com/@nabilakhram1730",
    color: "#FF0000",
  ...
  },
  {
    name: "TikTok",
    displayName: "Tiktok",
    subText: "@billnevergiveuphh",
    icon: ({ className, ...props }) => (
      <svg width="24px" height="24px" viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    ...
    url: "https://www.tiktok.com/@billnevergiveuphh",
    color: "black",
        ...
        <a href={primary.url} target="_blank" rel="noopener noreferrer"
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-gray-200 tracking-tight leading-none group-hover:text-white transition-colors duration-300">{primary.displayName}</span>
              <span className="text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-300">{primary.subText}</span>
            </div>
          </div>
