        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  ...
                  <div>
                    ...
                    <span data-aos="fade-up" data-aos-delay="2000" className="inline-block px-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      Website
                    </span>
                  </div>
                </h1>
              ...
              >
                <a
                  href="portofolio-kenzie3.vercel.app"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="portofolio-kenzie3.vercel.app" />
                    </span>
                  </div>
                </a>
              </motion.div>
