...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0" data-aos="zoom-in" data-aos-delay="400">
    <div className="relative group">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#0ea5e9] to-[#2563eb] rounded-full blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
        <span className="bg-gradient-to-r from-[#0ea5e9] to-[#2563eb] text-transparent bg-clip-text sm:text-sm text-[0.7rem] font-medium flex items-center">
...
const SocialLink = memo(({ icon: Icon, link, label }) => (
  <a href={link} target="_blank" rel="noopener noreferrer" aria-label={label}>
    <button className="group relative p-3"
      aria-label={label}>
      <div className="absolute inset-0 bg-gradient-to-r from-[#0ea5e9] to-[#2563eb] rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <span className="w-[3px] h-6 bg-gradient-to-t from-[#0ea5e9] to-[#2563eb] ml-1 animate-blink"></span>
                  </div>
              ...
              <div className="w-full py-0 md:py-[10%] sm:py-0 lg:w-1/2 h-[260px] sm:h-[400px] lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2  mt-5 sm:mt-0"
                ...
                <div className="relative w-full opacity-90">
                  <div className={`absolute inset-0 bg-gradient-to-r from-[#0ea5e9]/10 to-[#2563eb]/10 rounded-3xl blur-3xl transition-all duration-700 ease-in-out ${
