...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/akhramnabil09@gmail.com';
    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        <h2
          ...
          className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#2563eb]"
        >
          <span
            style={{
              color: "#0ea5e9",
              backgroundImage:
                "linear-gradient(45deg, #0ea5e9 10%, #2563eb 93%)",
      ...
      >
        className="container px-[1%] grid grid-cols-1 gap-12"
          <div
            ...
            className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 transform transition-all duration-500 hover:shadow-[#0ea5e9]/10 w-full max-w-3xl mx-auto"
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                <h2 className="text-4xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#2563eb]">
                  Hubungi
                </h2>
